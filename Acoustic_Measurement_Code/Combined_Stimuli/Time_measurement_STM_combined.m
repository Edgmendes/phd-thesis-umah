...
%Sample file
filename = "F1HzSR50_F50HzSR50_Fs500kHz_T3s_center130mm_offc10mm_step2.5mm.bin";
...
%Set the Combined stimuli
writeline(device,"l");
writeline(device,"10");		%SR1
writeline(device,"50");		%SR2
writeline(device,"1");		%Fmod
